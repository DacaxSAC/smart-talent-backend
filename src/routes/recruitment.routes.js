 ...
 * tags:
 *   name: Recruitment
 *   description: Endpoints para la gestión de reclutamientos
 */
 ...
 * /recruitments:
 *   post:
 *     summary: Crear un nuevo reclutamiento (solo Admin)
 *     tags: [Recruitment]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
...
router.post(
  "/",
  [authMiddleware, roleMiddleware(["ADMIN"]), roleValidation.create],
...
router.put(
  "/:id",
  [authMiddleware, roleMiddleware(["ADMIN"]), roleValidation.update],
